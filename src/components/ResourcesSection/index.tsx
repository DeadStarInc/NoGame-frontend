...
import { useAccount, useStarknet, useStarknetCall } from "@starknet-react/core";
...
export const ResourcesSection: FC = () => {
    ...
    const endTimeCompletion = useMemo(() => {
        if (timeCompletion) {
            const end = fromUnixTime(
                dataToNumber(timeCompletion["status"].lock_end)
            );
    ...
    const resourceCostUpgrade = useMemo(() => {
        if (resourcesUpgradesCost) {
            return {
                metal: {
                    metal: dataToNumber(
                        resourcesUpgradesCost["metal_mine"].metal
                    ),
                    crystal: dataToNumber(
                        resourcesUpgradesCost["metal_mine"].crystal
                    ),
                    deuterium: dataToNumber(
                        resourcesUpgradesCost["metal_mine"].deuterium
                    ),
                    energy: dataToNumber(
                        resourcesUpgradesCost["metal_mine"].energy_cost
                    ),
                },
                crystal: {
                    metal: dataToNumber(
                        resourcesUpgradesCost["crystal_mine"].metal
                    ),
                    crystal: dataToNumber(
                        resourcesUpgradesCost["crystal_mine"].crystal
                    ),
                    deuterium: dataToNumber(
                        resourcesUpgradesCost["crystal_mine"].deuterium
                    ),
                    energy: dataToNumber(
                        resourcesUpgradesCost["crystal_mine"].energy_cost
                    ),
                },
                deuterium: {
                    metal: dataToNumber(
                        resourcesUpgradesCost["deuterium_mine"].metal
                    ),
                    crystal: dataToNumber(
                        resourcesUpgradesCost["deuterium_mine"].crystal
                    ),
                    deuterium: dataToNumber(
                        resourcesUpgradesCost["deuterium_mine"].deuterium
                    ),
                    energy: dataToNumber(
                        resourcesUpgradesCost["deuterium_mine"].energy_cost
                    ),
                },
                solarPlant: {
                    metal: dataToNumber(
                        resourcesUpgradesCost["solar_plant"].metal
                    ),
                    crystal: dataToNumber(
                        resourcesUpgradesCost["solar_plant"].crystal
                    ),
                    deuterium: dataToNumber(
                        resourcesUpgradesCost["solar_plant"].deuterium
                    ),
                    energy: dataToNumber(
                        resourcesUpgradesCost["solar_plant"].energy_cost
                    ),
                },
            };
        }
    ...
    const facilitiesCostUpgrade = useMemo(() => {
        if (facilitiesUpgradesCost) {
            return {
                robots: {
                    metal: dataToNumber(
                        facilitiesUpgradesCost["robot_factory"].metal
                    ),
                    crystal: dataToNumber(
                        facilitiesUpgradesCost["robot_factory"].crystal
                    ),
                    deuterium: dataToNumber(
                        facilitiesUpgradesCost["robot_factory"].deuterium
                    ),
                },
                shipyard: {
                    metal: dataToNumber(
                        facilitiesUpgradesCost["shipyard"].metal
                    ),
                    crystal: dataToNumber(
                        facilitiesUpgradesCost["shipyard"].crystal
                    ),
                    deuterium: dataToNumber(
                        facilitiesUpgradesCost["shipyard"].deuterium
                    ),
                },
                lab: {
                    metal: dataToNumber(
                        facilitiesUpgradesCost["research_lab"].metal
                    ),
                    crystal: dataToNumber(
                        facilitiesUpgradesCost["research_lab"].crystal
                    ),
                    deuterium: dataToNumber(
                        facilitiesUpgradesCost["research_lab"].deuterium
                    ),
                },
                nanite: {
                    metal: dataToNumber(
                        facilitiesUpgradesCost["nanite_factory"].metal
                    ),
                    crystal: dataToNumber(
                        facilitiesUpgradesCost["nanite_factory"].crystal
                    ),
                    deuterium: dataToNumber(
                        facilitiesUpgradesCost["nanite_factory"].deuterium
                    ),
                },
            };
        }
    ...
    const endShipsCompletion = useMemo(() => {
        if (shipsCompletion) {
            const end = fromUnixTime(
                dataToNumber(shipsCompletion["status"].lock_end)
            );
            const timeDifferenceInMinutes = differenceInMinutes(
                end,
                new Date()
        ...
        if (shipsCost) {
            return {
                ...
                probe: {
                    ...
                    deuterium: dataToNumber(
                        shipsCost["espionage_probe"].deuterium
                    ),
                },
                satellite: {
                    ...
                    deuterium: dataToNumber(
                        shipsCost["solar_satellite"].deuterium
                    ),
                },
                fighter: {
                    ...
                    deuterium: dataToNumber(
                        shipsCost["light_fighter"].deuterium
                    ),
                },
                cruiser: {
    ...
    const techLevels = useMemo(() => {
        if (technologiesLevels) {
            return {
                ...
                astrophysics: dataToNumber(
                    technologiesLevels["result"].astrophysics
                ),
                combustion: dataToNumber(
                    technologiesLevels["result"].combustion_drive
                ),
                computer: dataToNumber(
                    technologiesLevels["result"].computer_tech
                ),
                energy: dataToNumber(technologiesLevels["result"].energy_tech),
                espionage: dataToNumber(
                    technologiesLevels["result"].espionage_tech
                ),
                hyperspaceDrive: dataToNumber(
                    technologiesLevels["result"].hyperspace_drive
                ),
                hyperspaceTech: dataToNumber(
                    technologiesLevels["result"].hyperspace_tech
                ),
                impulse: dataToNumber(
                    technologiesLevels["result"].impulse_drive
                ),
                ...
                shielding: dataToNumber(
                    technologiesLevels["result"].shielding_tech
                ),
                weapons: dataToNumber(
                    technologiesLevels["result"].weapons_tech
                ),
            };
        }
    }, [technologiesLevels]);
        ...
        if (techUpgradesCost) {
            return {
                armour: {
                    ...
                    crystal: dataToNumber(
                        techUpgradesCost["armour_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["armour_tech"].deuterium
                    ),
                },
                astrophysics: {
                    metal: dataToNumber(techUpgradesCost["astrophysics"].metal),
                    crystal: dataToNumber(
                        techUpgradesCost["astrophysics"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["astrophysics"].deuterium
                    ),
                },
                combustion: {
                    metal: dataToNumber(
                        techUpgradesCost["combustion_drive"].metal
                    ),
                    crystal: dataToNumber(
                        techUpgradesCost["combustion_drive"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["combustion_drive"].deuterium
                    ),
                },
                computer: {
                    metal: dataToNumber(
                        techUpgradesCost["computer_tech"].metal
                    ),
                    crystal: dataToNumber(
                        techUpgradesCost["computer_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["computer_tech"].deuterium
                    ),
                },
                energy: {
                    metal: dataToNumber(techUpgradesCost["energy_tech"].metal),
                    crystal: dataToNumber(
                        techUpgradesCost["energy_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["energy_tech"].deuterium
                    ),
                },
                espionage: {
                    metal: dataToNumber(
                        techUpgradesCost["espionage_tech"].metal
                    ),
                    crystal: dataToNumber(
                        techUpgradesCost["espionage_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["espionage_tech"].deuterium
                    ),
                },
                hyperspaceDrive: {
                    metal: dataToNumber(
                        techUpgradesCost["hyperspace_drive"].metal
                    ),
                    crystal: dataToNumber(
                        techUpgradesCost["hyperspace_drive"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["hyperspace_drive"].deuterium
                    ),
                },
                hyperspaceTech: {
                    metal: dataToNumber(
                        techUpgradesCost["hyperspace_tech"].metal
                    ),
                    crystal: dataToNumber(
                        techUpgradesCost["hyperspace_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["hyperspace_tech"].deuterium
                    ),
                },
                impulse: {
                    metal: dataToNumber(
                        techUpgradesCost["impulse_drive"].metal
                    ),
                    crystal: dataToNumber(
                        techUpgradesCost["impulse_drive"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["impulse_drive"].deuterium
                    ),
                },
                ion: {
                    ...
                    deuterium: dataToNumber(
                        techUpgradesCost["ion_tech"].deuterium
                    ),
                },
                laser: {
                    metal: dataToNumber(techUpgradesCost["laser_tech"].metal),
                    crystal: dataToNumber(
                        techUpgradesCost["laser_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["laser_tech"].deuterium
                    ),
                },
                plasma: {
                    metal: dataToNumber(techUpgradesCost["plasma_tech"].metal),
                    crystal: dataToNumber(
                        techUpgradesCost["plasma_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["plasma_tech"].deuterium
                    ),
                },
                shielding: {
                    metal: dataToNumber(
                        techUpgradesCost["shielding_tech"].metal
                    ),
                    crystal: dataToNumber(
                        techUpgradesCost["shielding_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["shielding_tech"].deuterium
                    ),
                },
                weapons: {
                    metal: dataToNumber(techUpgradesCost["weapons_tech"].metal),
                    crystal: dataToNumber(
                        techUpgradesCost["weapons_tech"].crystal
                    ),
                    deuterium: dataToNumber(
                        techUpgradesCost["weapons_tech"].deuterium
                    ),
                },
            };
        }
    ...
    const endTechCompletion = useMemo(() => {
        if (techCompletion) {
            const end = fromUnixTime(
                dataToNumber(techCompletion["status"].lock_end)
            );
            const timeDifferenceInMinutes = differenceInMinutes(
                end,
                new Date()
