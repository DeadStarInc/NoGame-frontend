...
export interface DefenceCost {
    rocket: { metal: any; crystal: any; deuterium: any };
    lightLaser: { metal: any; crystal: any; deuterium: any };
    heavyLaser: { metal: any; crystal: any; deuterium: any };
    ionCannon: { metal: any; crystal: any; deuterium: any };
    gauss: { metal: any; crystal: any; deuterium: any };
    plasmaTurret: { metal: any; crystal: any; deuterium: any };
    smallDome: { metal: any; crystal: any; deuterium: any };
    largeDome: { metal: any; crystal: any; deuterium: any };
}
